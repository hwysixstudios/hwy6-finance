...
const LABEL = ({ children }) => <span style={{ fontSize: 9, color: "#3a3a3a", letterSpacing: "0.2em", textTransform: "uppercase", marginBottom: 10, display: "block" }}>{children}</span>;
...
export default function HWY6Finance() {
  ...
  const ROW = { padding: "13px 16px", borderBottom: "1px solid #0f0f0f" };
  const THEAD = { padding: "10px 16px", borderBottom: "1px solid #1a1a1a", background: "#0e0e0e" };
  const TABLE = { border: "1px solid #1a1a1a", borderRadius: 2, overflow: "hidden", marginBottom: 24 };
  const CARD = { background: "#0e0e0e", border: "1px solid #1a1a1a", padding: "22px 24px" };
  const FORM = { background: "#0e0e0e", border: "1px solid #1e1e1e", padding: "18px", marginBottom: 14, borderRadius: 2 };
  const ADDBTN = { background: "#fff", color: "#000", border: "none", padding: "7px 16px", fontFamily: "'DM Mono',monospace", fontSize: 10, letterSpacing: "0.12em", textTransform: "uppercase", cursor: "pointer", fontWeight: 700 };
  const SAVEBTN = { background: "#fff", color: "#000", border: "none", padding: "8px 18px", fontFamily: "'DM Mono',monospace", fontSize: 10, letterSpacing: "0.12em", textTransform: "uppercase", cursor: "pointer", fontWeight: 700 };
  const CANCELBTN = { background: "none", border: "1px solid #2a2a2a", color: "#555", padding: "8px 14px", fontFamily: "'DM Mono',monospace", fontSize: 10, textTransform: "uppercase", cursor: "pointer" };
  const DELBTN = { background: "none", border: "none", color: "#2a2a2a", cursor: "pointer", fontSize: 15, padding: "2px 8px", fontFamily: "monospace" };
...
create policy "allow all" on config for all using (true) with check (true);`;
  ...
  if (dbReady === null) return (
    <div style={{ minHeight: "100vh", background: "#080808", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'DM Mono',monospace" }}>
      <div style={{ textAlign: "center" }}>
        ...
        <div style={{ fontSize: 10, color: "#2a2a2a", letterSpacing: "0.2em", textTransform: "uppercase" }}>Connecting to database...</div>
      </div>
    </div>
  );

  if (dbReady === false) return (
    <div style={{ minHeight: "100vh", background: "#080808", color: "#fff", fontFamily: "'DM Mono',monospace", padding: 40 }}>
      ...
      <div style={{ maxWidth: 700, margin: "0 auto" }}>
        ...
        <div style={{ fontSize: 10, color: "#333", letterSpacing: "0.2em", textTransform: "uppercase", marginBottom: 32 }}>Database Setup Required</div>
        {dbError && <div style={{ background: "#1a0a0a", border: "1px solid #3a1a1a", padding: 12, marginBottom: 20, fontSize: 11, color: "#f87171", borderRadius: 2 }}>Error: {dbError}</div>}
        <div style={{ background: "#0e0e0e", border: "1px solid #1e1e1e", padding: 24, marginBottom: 20, borderRadius: 2 }}>
          <div style={{ fontSize: 9, color: "#3a3a3a", letterSpacing: "0.2em", textTransform: "uppercase", marginBottom: 16 }}>Step 1 — Run this SQL in Supabase</div>
          <div style={{ fontSize: 10, color: "#666", marginBottom: 16, lineHeight: 1.6 }}>Go to <span style={{ color: "#60a5fa" }}>supabase.com</span> → your <strong style={{ color: "#fff" }}>hwy6-finance</strong> project → <strong style={{ color: "#fff" }}>SQL Editor</strong> → paste and run:</div>
          <pre style={{ background: "#080808", border: "1px solid #1a1a1a", padding: 16, fontSize: 10, color: "#4ade80", overflowX: "auto", borderRadius: 2, lineHeight: 1.7, whiteSpace: "pre-wrap" }}>{SQL_SETUP}</pre>
        ...
        <div style={{ background: "#0e0e0e", border: "1px solid #1e1e1e", padding: 24, borderRadius: 2 }}>
          <div style={{ fontSize: 9, color: "#3a3a3a", letterSpacing: "0.2em", textTransform: "uppercase", marginBottom: 12 }}>Step 2 — Connect</div>
          <div style={{ fontSize: 10, color: "#555", marginBottom: 16 }}>After running the SQL, click below to connect the app.</div>
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#080808", color: "#fff", fontFamily: "'DM Mono',monospace" }}>
      ...
      <div style={{ maxWidth: 1020, margin: "0 auto", padding: "30px 32px" }}>
        ...
        {tab === "dashboard" && (<>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 10, marginBottom: 24 }}>
            {[
              ...
              <div key={i} className="mc" style={CARD}>
                ...
                <div style={{ fontSize: 9, color: "#2a2a2a", letterSpacing: "0.1em" }}>{m.sub}</div>
              </div>
            ))}
          </div>
          ...
          <div className="mc" style={{ ...CARD, marginBottom: 24, display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 16 }}>
            <div>
              ...
              <div style={{ fontSize: 9, color: "#2a2a2a", marginTop: 2 }}>set aside from revenue</div>
            </div>
            <div style={{ textAlign: "right" }}>
              ...
              {editTax ? (
                <div style={{ display: "flex", gap: 6, marginTop: 8, justifyContent: "flex-end", alignItems: "center" }}>
                  <Inp style={{ width: 60, textAlign: "center" }} value={tempTax} onChange={e => setTempTax(e.target.value)} />
            ...
            return (
              <div className="mc" style={{ ...CARD, marginBottom: 24 }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: 12 }}>
                  ...
                  <div style={{ textAlign: "right" }}>
                    <div style={{ fontSize: 9, color: "#2a2a2a", letterSpacing: "0.15em", textTransform: "uppercase", marginBottom: 6 }}>{Math.round(pct)}% there</div>
                    {editTarget ? (
                      <div style={{ display: "flex", gap: 6, alignItems: "center", justifyContent: "flex-end" }}>
                        <Inp style={{ width: 90, textAlign: "center" }} value={tempTarget} onChange={e => setTempTarget(e.target.value)} placeholder="$" />
            ...
            {[
              ...
              return (
                <div key={i} className="mc" style={CARD}>
                  ...
                  <div style={{ fontSize: 9, color: "#2a2a2a", marginTop: 5 }}>{pct}% of total</div>
                </div>
              );
            })}
          </div>
          ...
          <div style={TABLE}>
            ...
            {productTotals.map(p => (
              <div key={p.id} className="tr" style={{ ...ROW, display: "grid", gridTemplateColumns: "2fr 1fr 1fr 1fr", alignItems: "center" }}>
                ...
                <span style={{ fontSize: 12, color: "#555" }}>{fmt(p.price)}</span>
          ...
          {showCF && (
            <div style={FORM}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, marginBottom: 10 }}>
                <Inp placeholder="Client name" value={nc.client} onChange={e => setNc(v => ({ ...v, client: e.target.value }))} />
                <Inp placeholder="Amount ($)" type="number" value={nc.amount} onChange={e => setNc(v => ({ ...v, amount: e.target.value }))} />
                <Inp placeholder="Job type" value={nc.jobType} onChange={e => setNc(v => ({ ...v, jobType: e.target.value }))} />
                <Sel value={nc.month} onChange={e => setNc(v => ({ ...v, month: e.target.value }))}>{MONTHS.map(m => <option key={m}>{m}</option>)}</Sel>
                <Sel value={nc.type} onChange={e => setNc(v => ({ ...v, type: e.target.value }))}><option value="retainer">Retainer</option><option value="one-off">One-Off</option></Sel>
                <Sel value={nc.status} onChange={e => setNc(v => ({ ...v, status: e.target.value }))}><option value="unpaid">Unpaid</option><option value="paid">Paid</option></Sel>
              </div>
          ...
          {groupByMonth(clients).map(({ month, items }) => {
            ...
            return (
              <div key={month} style={{ marginBottom: 20 }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "8px 0", marginBottom: 8, borderBottom: "1px solid #1a1a1a" }}>
                ...
                <div style={TABLE}>
                  ...
                  {items.map(c => (
                    <div key={c.id} className="tr" style={{ ...ROW, display: "grid", gridTemplateColumns: "2fr 1fr 1.4fr 0.8fr 0.8fr 36px", alignItems: "center" }}>
                      ...
                      <EF value={c.jobType || ""} onSave={v => updateClient(c.id, "jobType", v)} style={{ fontSize: 11, color: "#555" }} />
        ...
        {tab === "merch" && (<>
          ...
          {showPF && (
            <div style={FORM}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 10, marginBottom: 10 }}>
                <Inp placeholder="Product name" value={np.name} onChange={e => setNp(v => ({ ...v, name: e.target.value }))} />
                <Inp placeholder="Price ($)" type="number" value={np.price} onChange={e => setNp(v => ({ ...v, price: e.target.value }))} />
                <Sel value={np.category} onChange={e => setNp(v => ({ ...v, category: e.target.value }))}>
          ...
          <div style={TABLE}>
            ...
            {productTotals.map(p => (
              <div key={p.id} className="tr" style={{ ...ROW, display: "grid", gridTemplateColumns: "2fr 1fr 1.2fr 1fr 1fr 36px", alignItems: "center" }}>
                ...
                <EF value={p.price} type="number" onSave={v => updateProduct(p.id, "price", v)} style={{ fontSize: 12, color: "#555" }} />
          ...
          {showSlF && (
            <div style={FORM}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 10, marginBottom: 10 }}>
                <Sel value={nsl.productId} onChange={e => setNsl(v => ({ ...v, productId: e.target.value }))}>
                  <option value="">Select product</option>
                  {products.map(p => <option key={p.id} value={p.id}>{p.name}</option>)}
                </Sel>
                <Inp placeholder="Qty" type="number" value={nsl.qty} onChange={e => setNsl(v => ({ ...v, qty: e.target.value }))} />
                <Sel value={nsl.month} onChange={e => setNsl(v => ({ ...v, month: e.target.value }))}>{MONTHS.map(m => <option key={m}>{m}</option>)}</Sel>
              </div>
        ...
        {tab === "subscriptions" && (<>
          ...
          {showSF && (
            <div style={FORM}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, marginBottom: 10 }}>
                <Inp placeholder="Name" value={ns.name} onChange={e => setNs(v => ({ ...v, name: e.target.value }))} />
                <Inp placeholder="Amount ($/mo)" type="number" value={ns.amount} onChange={e => setNs(v => ({ ...v, amount: e.target.value }))} />
                <Sel value={ns.category} onChange={e => setNs(v => ({ ...v, category: e.target.value }))}>
                  <option>Software / SaaS</option><option>Marketing & Ads</option><option>Business / LLC</option>
                </Sel>
                <Sel value={ns.billing} onChange={e => setNs(v => ({ ...v, billing: e.target.value }))}>
          ...
          <div style={TABLE}>
            ...
            {subs.map(sub => (
              <div key={sub.id} className="tr" style={{ ...ROW, display: "grid", gridTemplateColumns: "2fr 1.5fr 1fr 1fr 36px", alignItems: "center" }}>
                ...
                <EF value={sub.category} options={["Software / SaaS","Marketing & Ads","Business / LLC"]} onSave={v => updateSub(sub.id, "category", v)} style={{ fontSize: 11, color: "#555" }} />
        ...
        {tab === "events" && (<>
          ...
          {showEventF && (
            <div style={FORM}>
              <div style={{ fontSize: 9, color: "#3a3a3a", letterSpacing: "0.2em", textTransform: "uppercase", marginBottom: 12 }}>New Event</div>
              <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr", gap: 10, marginBottom: 10 }}>
                <Inp placeholder="Event name" value={newEvent.name} onChange={e => setNewEvent(v => ({ ...v, name: e.target.value }))} />
                <Sel value={newEvent.month} onChange={e => setNewEvent(v => ({ ...v, month: e.target.value }))}>{MONTHS.map(m => <option key={m}>{m}</option>)}</Sel>
                <Sel value={newEvent.status} onChange={e => setNewEvent(v => ({ ...v, status: e.target.value }))}><option value="upcoming">Upcoming</option><option value="past">Past</option></Sel>
              </div>
              <Inp placeholder="Description (optional)" value={newEvent.description} onChange={e => setNewEvent(v => ({ ...v, description: e.target.value }))} style={{ marginBottom: 10 }} />
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            {events.map(ev => {
              ...
              return (
                <div key={ev.id} style={{ border: "1px solid #1a1a1a", borderRadius: 2, overflow: "hidden" }}>
                  {/* Event header */}
                  <div style={{ background: "#0e0e0e", padding: "18px 20px", cursor: "pointer" }} onClick={() => setExpandedEvent(isExpanded ? null : ev.id)}>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                      ...
                      <div style={{ display: "flex", alignItems: "center", gap: 20 }}>
                        <div style={{ textAlign: "right" }}>
                          <div style={{ fontSize: 9, color: "#2a2a2a", letterSpacing: "0.15em", textTransform: "uppercase", marginBottom: 2 }}>Net</div>
                          <div style={{ fontFamily: "'Bebas Neue',sans-serif", fontSize: 22, color: net >= 0 ? "#4ade80" : "#f87171" }}>{fmt(net)}</div>
                        </div>
                        <div style={{ display: "flex", gap: 6 }}>
                          <Sel style={{ width: "auto", fontSize: 10, padding: "4px 8px", background: "#111" }}
                            value={ev.status}
                    ...
                    {ev.description !== undefined && <div style={{ fontSize: 11, color: "#333", marginTop: 6 }}><EF value={ev.description || ""} onSave={v => updateEvent(ev.id, "description", v)} style={{ fontSize: 11, color: "#444" }} /></div>}
                    ...
                    <div style={{ display: "flex", gap: 24, marginTop: 14 }}>
                      {[
                        ...
                        <div key={i}>
                          <div style={{ fontSize: 9, color: "#2a2a2a", letterSpacing: "0.15em", textTransform: "uppercase", marginBottom: 2 }}>{s.label}</div>
                    ...
                    <div style={{ padding: "20px", borderTop: "1px solid #141414" }}>
                      ...
                      <div style={{ marginBottom: 20 }}>
                        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
                          <span style={{ fontSize: 9, color: "#3a3a3a", letterSpacing: "0.2em", textTransform: "uppercase" }}>Revenue</span>
                        ...
                        {showEventRevF === ev.id && (
                          <div style={{ ...FORM, marginBottom: 10 }}>
                            <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr", gap: 10, marginBottom: 10 }}>
                              <Inp placeholder="Description (e.g. Ticket Sales)" value={newEventRev.description} onChange={e => setNewEventRev(v => ({ ...v, description: e.target.value }))} />
                              <Inp placeholder="Amount ($)" type="number" value={newEventRev.amount} onChange={e => setNewEventRev(v => ({ ...v, amount: e.target.value }))} />
                              <Sel value={newEventRev.type} onChange={e => setNewEventRev(v => ({ ...v, type: e.target.value }))}>
                      ...
                      <div>
                        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
                          <span style={{ fontSize: 9, color: "#3a3a3a", letterSpacing: "0.2em", textTransform: "uppercase" }}>Expenses</span>
                          <button style={ADDBTN} onClick={() => setShowEventExpF(showEventExpF === ev.id ? null : ev.id)}>+ Add Expense</button>
                        </div>
                        {showEventExpF === ev.id && (
                          <div style={{ ...FORM, marginBottom: 10 }}>
                            <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr", gap: 10, marginBottom: 10 }}>
                              <Inp placeholder="Description (e.g. Venue deposit)" value={newEventExp.description} onChange={e => setNewEventExp(v => ({ ...v, description: e.target.value }))} />
                              <Inp placeholder="Amount ($)" type="number" value={newEventExp.amount} onChange={e => setNewEventExp(v => ({ ...v, amount: e.target.value }))} />
                              <Sel value={newEventExp.category} onChange={e => setNewEventExp(v => ({ ...v, category: e.target.value }))}>
        ...
        {tab === "contractors" && (<>
          ...
          {showContractorF && (
            <div style={FORM}>
              <div style={{ fontSize: 9, color: "#3a3a3a", letterSpacing: "0.2em", textTransform: "uppercase", marginBottom: 12 }}>New Contractor</div>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 10, marginBottom: 10 }}>
                <Inp placeholder="Name" value={nc2.name} onChange={e => setNc2(v => ({ ...v, name: e.target.value }))} />
                <Inp placeholder="Role (e.g. Editor)" value={nc2.role} onChange={e => setNc2(v => ({ ...v, role: e.target.value }))} />
                <Inp placeholder="Handle / IG (optional)" value={nc2.handle} onChange={e => setNc2(v => ({ ...v, handle: e.target.value }))} />
              </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            {contractors.map(c => {
              ...
              return (
                <div key={c.id} style={{ border: "1px solid #1a1a1a", borderRadius: 2, overflow: "hidden" }}>
                  {/* Profile header */}
                  <div style={{ background: "#0e0e0e", padding: "16px 20px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
                      <div style={{ width: 36, height: 36, borderRadius: "50%", background: "#1a1a1a", border: "1px solid #2a2a2a", display: "flex", alignItems: "center", justifyContent: "center" }}>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                      <div style={{ textAlign: "right" }}>
                        <div style={{ fontSize: 9, color: "#2a2a2a", letterSpacing: "0.15em", textTransform: "uppercase" }}>Total Paid Out</div>
                  ...
                  {isLogging && (
                    <div style={{ ...FORM, margin: 0, borderRadius: 0, borderTop: "1px solid #1e1e1e" }}>
                      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 2fr", gap: 10, marginBottom: 10 }}>
                        <Inp placeholder="Amount ($)" type="number" value={npay.amount} onChange={e => setNpay(v => ({ ...v, amount: e.target.value }))} />
                        <Sel value={npay.month} onChange={e => setNpay(v => ({ ...v, month: e.target.value }))}>{MONTHS.map(m => <option key={m}>{m}</option>)}</Sel>
                        <Inp placeholder="Note (e.g. Edit — Matière Desirée video)" value={npay.note} onChange={e => setNpay(v => ({ ...v, note: e.target.value }))} />
                      </div>
                  ...
                  {cPayments.length > 0 && (
                    <div>
                      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 2fr 36px", padding: "8px 20px", background: "#080808", borderTop: "1px solid #111" }}>
                      ...
                      {cPayments.map(p => (
                        <div key={p.id} className="tr" style={{ ...ROW, display: "grid", gridTemplateColumns: "1fr 1fr 2fr 36px", alignItems: "center", paddingLeft: 20 }}>
                          ...
                          <EF value={p.month} options={MONTHS} onSave={v => updatePayment(p.id, "month", v)} style={{ fontSize: 11, color: "#444" }} />
                          <EF value={p.note || ""} onSave={v => updatePayment(p.id, "note", v)} style={{ fontSize: 11, color: "#555" }} />
          ...
          {contractors.length > 0 && (
            <div style={{ display: "flex", justifyContent: "flex-end", marginTop: 16, padding: "12px 16px", border: "1px solid #1a1a1a", background: "#0a0a0a" }}>
        ...
        {tab === "expenses" && (<>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16 }}>
            <div>
              ...
              <span style={{ fontSize: 10, color: "#2a2a2a" }}>Tax deductible entries reduce your taxable income</span>
            </div>
          ...
          {showExpF && (
            <div style={FORM}>
              <div style={{ fontSize: 9, color: "#3a3a3a", letterSpacing: "0.2em", textTransform: "uppercase", marginBottom: 12 }}>New Expense</div>
              <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr 1fr", gap: 10, marginBottom: 10 }}>
                <Inp placeholder="Description" value={nexp.description} onChange={e => setNexp(v => ({ ...v, description: e.target.value }))} />
                <Inp placeholder="Amount ($)" type="number" value={nexp.amount} onChange={e => setNexp(v => ({ ...v, amount: e.target.value }))} />
                <Sel value={nexp.month} onChange={e => setNexp(v => ({ ...v, month: e.target.value }))}>{MONTHS.map(m => <option key={m}>{m}</option>)}</Sel>
                <Sel value={nexp.category} onChange={e => setNexp(v => ({ ...v, category: e.target.value }))}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 14 }}>
                ...
                <label htmlFor="deductible" style={{ fontSize: 11, color: "#555", cursor: "pointer", letterSpacing: "0.05em" }}>Tax deductible</label>
              </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 10, marginBottom: 20 }}>
            {[
              ...
              <div key={i} className="mc" style={CARD}>
                <div style={{ fontSize: 9, color: "#2a2a2a", letterSpacing: "0.2em", textTransform: "uppercase", marginBottom: 8 }}>{s.label}</div>
        ...
        {tab === "p&l" && (<>
          <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 24 }}>
            ...
            <Sel style={{ width: "auto" }} value={plMonth} onChange={e => setPlMonth(e.target.value)}>
              {MONTHS.map(m => <option key={m}>{m}</option>)}
            </Sel>
          ...
          <div style={{ ...TABLE, marginBottom: 0 }}>
            <div style={{ padding: "12px 20px", borderBottom: "1px solid #141414", background: "#0d0d0d" }}>
              <span style={{ fontSize: 9, color: "#2a2a2a", letterSpacing: "0.2em", textTransform: "uppercase" }}>Revenue</span>
            </div>
            {[
            ...
            <div style={{ ...ROW, display: "flex", justifyContent: "space-between", alignItems: "center", background: "#0d0d0d", borderTop: "1px solid #1a1a1a" }}>
              <span style={{ fontSize: 10, color: "#555", textTransform: "uppercase", letterSpacing: "0.1em" }}>Total Revenue</span>
            ...
            <div style={{ padding: "12px 20px", borderBottom: "1px solid #141414", borderTop: "1px solid #1e1e1e", background: "#0d0d0d" }}>
              <span style={{ fontSize: 9, color: "#2a2a2a", letterSpacing: "0.2em", textTransform: "uppercase" }}>Expenses</span>
            </div>
            {subs.map(sub => (
              <div key={sub.id} className="tr" style={{ ...ROW, display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <span style={{ fontSize: 12, color: "#444" }}>{sub.name}</span>
            ...
            <div style={{ padding: "14px 20px", display: "flex", justifyContent: "space-between", alignItems: "center", borderTop: "1px solid #141414", background: "#090909" }}>
              <span style={{ fontSize: 10, color: "#444", textTransform: "uppercase", letterSpacing: "0.15em" }}>Tax Reserve ({Math.round(taxRate * 100)}%)</span>
              <span style={{ fontFamily: "'Bebas Neue',sans-serif", fontSize: 22, color: "#fb923c" }}>({fmt(plTax)})</span>
            </div>

            <div style={{ padding: "20px", display: "flex", justifyContent: "space-between", alignItems: "center", borderTop: "1px solid #1e1e1e", background: "#080808" }}>
